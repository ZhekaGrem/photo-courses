...
const data: InfoType[] = [
  ...
  { id: 2, title: '02 ЕКСПОЗИЦІЯ, ДІАФРАГМА, ЗАМІР ЕКСПОЗИЦІЇ ', content: 'Содержимое блока 2' },
  { id: 3, title: '03 ВИТРИМКА ТА ISO (СВІТЛОЧУТЛИВІСТЬ)', content: 'Содержимое блока 3' },
  { id: 4, title: '04 КОМПОЗИЦІЯ', content: 'Содержимое блока 3' },
  { id: 5, title: '05 КОЛІР', content: 'Содержимое блока 3' },
