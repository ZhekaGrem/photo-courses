            ...
            <div className="bg-white shadow-[5px_5px_15px_rgba(0,0,0,0.1),-5px_-5px_15px_rgba(255,255,255,0.8)] rounded-xl p-6">
              ...
              <p className="text-gray-600">
               {` Ми впевнені у якості нашого курсу, але розуміємо, що плани можуть змінюватися. Тому ми
                пропонуємо гнучку політику повернення коштів: якщо ви вирішите відмовитися від участі за 2 тижні до початку курсу, ми гарантуємо повне повернення коштів. Це наше обовязання перед вами та демонстрація впевненості у цінності нашого продукту.`}</p>
            </div>
          </div>
